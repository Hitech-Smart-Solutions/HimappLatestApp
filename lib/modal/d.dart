...
//   User({required this.id, required this.display, required this.fullName});
// }
...
//     final textUntilCursor = val.substring(0, cursorPos);
//     final mentionIndex = textUntilCursor.lastIndexOf('@');
...
//     final query = textUntilCursor.substring(mentionIndex + 1);
...
//   void onUserSelected(
//       String userName, String userId, void Function(void Function()) setState) {
...
//     if (mentionIndex == -1) return; // safety check

//     // Construct mention markup
//     final mentionMarkup = '@[$userId]($userName)';

//     // Replace from '@' till cursor with mention markup
//     final newText = text.replaceRange(mentionIndex, cursorPos, mentionMarkup);

//     _controller.text = newText;

//     // Move cursor to right after inserted mention
//     _controller.selection =
//         TextSelection.collapsed(offset: mentionIndex + mentionMarkup.length);
...
//       // Extract mentions using the markup pattern
//       final mentionRegex = RegExp(r'\@\[(.*?)\]\((.*?)\)');
//       final matches = mentionRegex.allMatches(text);

//       List<User> mentionedUsers = matches.map((match) {
//         final id = match.group(1)!;
//         final userName = match.group(2)!;
//         return User(id: id, display: userName, fullName: '');
//       }).toList();

//       // Remove mentions to get plain comment
//       final plainComment = text.replaceAll(mentionRegex, '').trim();

//       print(
//           'Mentioned users: ${mentionedUsers.map((u) => u.display).toList()}');
//       print('Plain comment: "$plainComment"');

//       // Here you can build your ActivityDTO list and call your API etc.
//       // For demo, just print success and clear

//       print('Sending comment & mentions...');

//       await Future.delayed(Duration(seconds: 1)); // simulate network delay

//       print('✅ Successfully sent comment and mentions');
...
//                   mainAxisSize: MainAxisSize.min,
//                   crossAxisAlignment:
//                       CrossAxisAlignment.end, // Aligns button right
//                   children: [
//                     TextField(
...
//   //                     data: userList, // ✅ dynamic from API
//   //                     matchAll: true,
