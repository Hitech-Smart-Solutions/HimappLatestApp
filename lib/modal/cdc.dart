...
class _MaterialRequisitionSlipState extends State<MaterialRequisitionSlip> {
  ...
  void initState() {
    ...
    if (widget.slipId != null) {
      ...
      isEditMode = true;
      showForm = true;
      editLoading = true; // 🔥 START LOADING
                    ...
                    Expanded(
                      child: DropdownSearch<ItemModel>(
                        ...
                        popupProps: PopupProps.dialog(
                          ...
                          /// 🔥 List item UI (overflow fix inside popup)
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          // 🔥 IMPORTANT
                                          child: _infoText("Item", item.item),
                                        ),
                                        Row(
                                          children: [
                                            IconButton(
